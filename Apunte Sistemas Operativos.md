...
## Primera Conclusión
No importan tanto las caracter ́ısticas del hardware. Si lo que vamosa  desarrollar  est ́a  organizado  en  forma  de  diferentes  tareas  queejecutan en forma concurrente, necesitamos una pieza de softwareque administre la forma en que los recursos de hardware se van aa asignar a cada tarea (o proceso).De otra manera no existe protecci ́on entre tareas, y no se puedeproveer sincronizaci ́on entre los diferentes procesos para accedera un mismo recurso, por citar solo las calamidades mas evidentes.
